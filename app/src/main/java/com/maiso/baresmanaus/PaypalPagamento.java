 ...
 */
public class PaypalPagamento extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paypal_pagamento);
    ...
    public void onBuyPressed(View pressed) {
        ...
        Intent intent = new Intent(PaypalPagamento.this, PaymentActivity.class);
    ...
    public void onFuturePaymentPressed(View pressed) {
        Intent intent = new Intent(PaypalPagamento.this, PayPalFuturePaymentActivity.class);
    ...
    public void onProfileSharingPressed(View pressed) {
        Intent intent = new Intent(PaypalPagamento.this, PayPalProfileSharingActivity.class);
